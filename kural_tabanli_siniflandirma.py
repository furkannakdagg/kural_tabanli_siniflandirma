...
df = pd.read_csv('Modul_1_PythonProgrammingForDataScience/Kural_Tabanli_Siniflandirma/persona.csv')
df.head()
df.shape
df.info()
...
agg_df[["COUNTRY", "SOURCE", "SEX", "age_cat"]].head().apply(lambda x: print(x), axis=1)
